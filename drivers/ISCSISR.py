...
DRIVER_INFO = {
    'name': 'iSCSI',
    'description': 'Raw ISCSI SR driver, provides a LUN-per-VDI. Does not support creation of VDIs but accesses existing LUNs on a target.',
...
class ISCSISR(ISCSI_base.BaseISCSISR):
    ...
    def load(self, vdi_uuid):
        super(ISCSISR, self).load(vdi_uuid)
        self.managed = True
