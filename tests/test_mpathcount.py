...
class TestMpathCount(unittest.TestCase):
    ...
    @mock.patch('sm.mpathcount.get_path_count', return_value=(2, 4))
    ...
    @mock.patch('sm.mpathcount.get_dm_major')
    @mock.patch('sm.mpathcount.get_root_dev_major')
    @mock.patch('sm.mpathcount.update_config', autospec=True)
    ...
    @mock.patch('sm.mpathcount.sys.exit', autospec=True)
    ...
    @mock.patch('sm.mpathcount.sys.exit', autospec=True)
    @mock.patch('sm.mpathcount.util.SMlog', autospec=True)
    @mock.patch('sm.mpathcount.subprocess.Popen', autospec=True)
