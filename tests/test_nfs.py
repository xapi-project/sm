...
class Test_nfs(unittest.TestCase):
    ...
    @mock.patch('sm.nfs.util.pread', autospec=True)
    ...
    @mock.patch('sm.nfs.time.sleep', autospec=True)
    @mock.patch('sm.nfs.get_supported_nfs_versions', autospec=True)
    # Can't use autospec due to http://bugs.python.org/issue17826
    @mock.patch('sm.nfs.util.pread')
    ...
    @mock.patch('sm.nfs._is_nfs4_supported', autospec=True)
    @mock.patch('sm.nfs.time.sleep', autospec=True)
    # Can't use autospec due to http://bugs.python.org/issue17826
    @mock.patch('sm.nfs.util.pread')
    ...
    @mock.patch('sm.nfs.util.makedirs', autospec=True)
    @mock.patch('sm.nfs.util.pread', autospec=True)
